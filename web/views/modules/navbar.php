    ...
    <div class="container py-2 py-lg-4">
      <div class="row">
        ...
        <div class="col-12 col-lg-7 col-xl-8 mt-1 px-3 px-lg-0">
          ...
          <div class="px-1 float-start dropdown templateColor" >
              ...
              <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                ...
                <li class="dropdown-submenu dropdown-hover">
                  ...
                  <ul  class="border-0 py-3 ps-3 d-block d-lg-none shadow">
                    <li>
                ...
                <li class="dropdown-submenu dropdown-hover">
                  ...
                  <ul class="border-0 py-3 ps-3 d-block d-lg-none shadow">
                    <li>
                      <a tabindex="-1" href="#" class="dropdown-item">Telefonia moviles</a>
                    </li>
                    <li>
                      <a tabindex="-1" href="#" class="dropdown-item">Tabletas electronicas</a>
                    </li>
                    <li>
                      <a tabindex="-1" href="#" class="dropdown-item">Computadores</a>
                    </li>
                    <li>
