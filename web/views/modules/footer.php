  ...
  <div class="container py-5 text-light">
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3">
      ...
      <div class="col my-3 my-lg-0 px-lg-5 text-light">
        ...
        <br>
        <h1 class="lead small">
          <i class="fa fa-phone-square pe-2"></i> (555) 555-85-85
          <br><br>
          <i class="fa fa-envelope pe-2"> soporte@tiendavirtual.com</i>
          <br><br>
          <i class="fa fa-map-marker pe-2"></i> Calle 45 # 25-12 Local 1002
          <br><br>
          Bogotá | Colombia
        </h1>
      ...
      <form role="form" method="post" >
        ...
        <input type="submit" value="Enviar" class="btn btn-default float-end border-o templateColor" id="enviar">         
...
<footer class="main-footer topColor">
  <div class="container">
    ...
    <!-- Default to the left -->
    <small>&copy; <?php echo date("Y") ?> Todos los derechos reservados. Sitio elaborado por Leonardo Zambrano A</small> 
  </div>
</footer> 